...
public class MainFrame extends JFrame {
	...
	private Library libraryMenu = new Library();
	...
	public MainFrame() {
		...
		profileImage.add(ImageEdit.clipPhoto("C:\\Users\\Amrit\\Pictures\\Progetto\\1495088003327.jpg"));
		RapidMenuPanel.add(profileImage, BorderLayout.NORTH);
		profileImage.setLayout(new BoxLayout(profileImage, BoxLayout.X_AXIS));
