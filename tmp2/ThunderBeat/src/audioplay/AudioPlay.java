...
public class AudioPlay extends JInternalFrame implements LineListener {
...
//		player = new JInternalFrame();
		...
		this.setJMenuBar(greenMenu);

		this.getContentPane().setLayout(new FlowLayout());
		this.setTitle(wavfile.getName());
		...
		thishttp://thunderbeat.altervista.org/trova.php?title=Marvin+Gaye+%26+Tammi+Terrell.getContentPane().add(pauseBtn);
